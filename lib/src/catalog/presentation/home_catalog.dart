...
class _CatalogScreenState extends State<CatalogScreen> {
  ...
  Future<void> fetchProfessionalServices() async {
    ...
    if (token != null) {
      final url = Uri.parse(
          'https://marquei-api.fly.dev/api/services/professional/me/');
  ...
  Future<void> fetchProfessionalCategories() async {
    ...
    if (token != null) {
      final url = Uri.parse(
          'https://marquei-api.fly.dev/api/professionals/category/');
    ...
    return Column(
      children: categoriesToShow.map<Widget>((cat) {
        return GestureDetector(
          onTap: () {
            // ação ao apertar no card da categoria
          },
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  cat['description'] ?? 'Descrição não disponível',
                  style: const TextStyle(
                    fontSize: 14,
