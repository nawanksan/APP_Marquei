...
void main() {
  ...
  testWidgets('TelaMaisState carrega corretamente',
  ...
  testWidgets('Todos os CustomInkWell estão presentes',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));
  ...
  testWidgets('Verifica a presença do RefreshIndicator e simula refresh',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));
  ...
  testWidgets('Verifica a presença das seções "Negócio" e "Ajustes"',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));
  ...
  testWidgets('Verifica se a CustomAppBar está sendo renderizada',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));

    // Verifica se a AppBar foi renderizada
    expect(find.byType(AppBar),
        findsNothing); // Certifica-se de que a AppBar padrão não foi usada
    expect(find.byType(PreferredSize),
        findsOneWidget); // Verifica o uso de PreferredSize (CustomAppBar)
  });

  testWidgets('Verifica a presença do botão "Sair"',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));
  ...
  testWidgets('Verifica a presença do texto "Versão 1.0.0"',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: TelaMaisState()));
